          ...
          <?php foreach($subdatas as $key => $subdata) : ?>
            ...
            <div class="space-y-1">
              ...
              <div class="w-full bg-gray-200 rounded-full h-3">
                <div class="bg-secondary-100 text-xs font-medium h-4 text-white text-center p-0.5 leading-none rounded-l-full max-w-full" style="width: <?= $subdata['persen'] ?>%"><?= $subdata['persen'] ?>%</div>
              </div>
            </div>
          <?php endif ?>
        <?php endforeach ?>
