  ...
  <div class="box-body" style="padding-top: .1rem;">
    <ul class="nav nav-tabs flex flex-col md:flex-row flex-wrap list-none border-b-0 pl-0 mb-4" id="tab-arsip" role="tablist">
      ...
      <li class="nav-item flex-grow text-center" role="presentation"><a href="#populer"
          class="nav-link w-full block font-medium border-x-0 border-t-0 border-b-2 border-transparent px-6 py-3 my-2 hover:border-transparent hover:bg-gray-100 focus:border-transparent"
      ...
      <div id="<?= $jenis ?>" class="tab-pane fade <?php ($jenis == 'terkini') and print('show active') ?>" role="tabpanel">
        <div class="divide-y">
          ...
          <div class="flex gap-3 py-3">
            <a href="<?= site_url('artikel/'.buat_slug($arsip))?>" class="w-1/4 flex-shrink-0">
